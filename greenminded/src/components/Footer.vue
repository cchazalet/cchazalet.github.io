      ...
      <section class="">
        ...
        <div class="row">
          ...
          <div class="col-md-3 col-lg-3 col-xl-3 mx-auto mt-3">
            <h6 class="text-uppercase mb-4 font-weight-bold">Greenminded</h6>
            <p>
              Site de comparateurs de trajets en transports en communs et qui
              classerait les différents voyages à travers un indicateur qui
              prend en compte le prix, le temps, le nombre de correspondances et
